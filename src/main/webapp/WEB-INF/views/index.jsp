...
<script type="text/javascript">
    ...
    function switchFont(){
        window.location.href="${path }/../dist";
    }
</script>
</head>
<body>
        ...
        <div data-options="region:'north',border:false" style="overflow: hidden;">
            <div>
                <span style="float: right; padding-right: 20px; margin-top: 15px; color: #333">
                    ...
                    &nbsp;
                    <a href="javascript:void(0)" onclick="switchFont()" class="easyui-linkbutton" plain="true">切换前台</a>
                </span>
...
<!--                     <script src='https://git.oschina.net/wangzhixuan/spring-shiro-training/widget_preview'></script> -->
        ...
        <div data-options="region:'south',border:false" style="height: 30px;line-height:30px; overflow: hidden;text-align: center;background-color: #eee" >Copyright © 2017 power by <a href="" target="_blank">弘洲科技</a></div>
    </div>
    <div id="tabsMenu">
